    ...
    def showBars(self):
        while video.isOpened():
            ...
            if ret == True:
                ...
                for i in range(11):
                   line = cv2.line(frame, (-0.0011*((i+1)*10)**2 +0.2512*((i+1)*10)+36.675, 70), 
                                   (-0.0011*((i+1)*10)**2 +0.2512*((i+1)*10)+36.675, 170), 
                                   (0, 0, 244), 4)
                   cv2.imshow('bars', line)
                   for j in range(10):
                        line2 = cv2.line(frame, (-0.0011*((j+1) + (i*10))**2 +0.2512*((j+1) + (i*10))+36.675, 70),
                                          (-0.0011*((j+1) + (i*10))**2 +0.2512*((j+1) + (i*10))+36.675, 170), 
                                          (0, 244, 0), 2)
